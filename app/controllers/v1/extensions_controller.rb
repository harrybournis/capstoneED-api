...
class V1::ExtensionsController < ApplicationController
  ...
  # POST /extensions
  def create
    unless current_user.pa_forms.where(id: params[:pa_form_id]).any? &&
           current_user.projects.where(id: params[:project_id]).any?
    ...
    if extension.save
      ...
      render json: format_errors(extension.errors),
