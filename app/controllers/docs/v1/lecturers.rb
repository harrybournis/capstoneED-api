class Docs::V1::Lecturers < ApplicationController
	...
	description <<-EOS
		Register a new Lecturer resource that is authenticatable with email and password.
	...
	description <<-EOS
		...
		be provided as <b>current_password</b> in the params. A Lecturer can only update themselves.
	EOS
	def update
	end
	...
	description <<-EOS
		...
		be included in the body as <b>current_password </b>. A Lecturer can only delete themselves.
	EOS
	def destroy
	end
end
