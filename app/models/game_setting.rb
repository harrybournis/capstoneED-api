...
class GameSetting < ApplicationRecord
  ...
  # points_peer_assessment_first_of_day :integer
  ...
  # points_project_evaluation_first_of_day :integer
  ...
  def set_default_values
    ...
    self.points_peer_assessment_first_of_day ||= POINTS_PEER_ASSESSMENT_FIRST_OF_DAY
    ...
    self.points_project_evaluation_first_of_day ||= POINTS_PROJECT_EVALUATION_FIRST_OF_DAY
