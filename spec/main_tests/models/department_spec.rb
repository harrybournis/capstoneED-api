...
RSpec.describe Department, type: :model do
	...
	# 	department = FactoryBot.create(:department, { university: uni, name: dep_name })
	# 	expect(department.valid?).to be_truthy

	# 	department2 = FactoryBot.build(:department, { university: uni, name: dep_name })
	...
	# 	department3 = FactoryBot.build(:department, { university: uni, name: 'Psychology' })
	# 	expect(department3.valid?).to be_truthy

	# 	department4 = FactoryBot.build(:department, { university: 'Yale', name: dep_name })
