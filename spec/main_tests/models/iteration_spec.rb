...
RSpec.describe Iteration, type: :model do
  ...
  #it '#evaluation_submission_period_middle returns the range between the dates in 40-50% of the iteration length'

  # it '#evaluation_submission_period_end returns the range between the dates in 90-100% of the iteration length'
end
